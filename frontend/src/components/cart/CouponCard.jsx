...
export default function CouponCard() {
  return (
    <div className="flex flex-col custom-lg:flex-row  gap-[10px] shadow-md rounded-[3px] overflow-hidden w-full  custom-lg:max-w-lg mt-[30px] custom-lg:mt-[40px] ">
      ...
      <div className="flex-1 p-5 custom-lg:p-6 flex flex-col justify-between bg-white">
