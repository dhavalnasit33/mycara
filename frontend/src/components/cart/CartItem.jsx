...
//                     <td className="py-4"> <button className=" w-[20px] h-[20px]">
//                         <img src={remove}/>
//                         </button>
//                     </td>
...
//                                 src={item.image}
//                                 alt={item.name}
//                                 className=" box-shadow object-cover p-[5px] h-[176px] "
//                             />
//                     </td>
...
//                     {/* Quantity */}
//                     <td className="p-4">
//                       <div className="inline-flex items-center gap-[10px] px-[8px] py-[5px] border-[#BCBCBC] border text-black leading rounded-[20px] ">
//                         <button>−</button>
...
//                     {/* Unit Price */}
//                     <td className="p-4 text-left">₹{item.price} * 1</td>
        ...
        <tbody>
          {items.map((item, index) => (
            <tr key={index} className="border-b border-[#BCBCBC] font-18 sec-text-color">
              ...
              <td className="p-4">
                <div className="inline-flex items-center gap-[10px] px-[8px] py-[5px] border-[#BCBCBC] border text-black rounded-[20px]">
