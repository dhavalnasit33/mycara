    ...
    <header className="bg-pink-50 shadow-md">
      ...
      <div className="flex justify-between items-center px-4 md:px-[100px] py-3">
        ...
        <nav className="hidden lg:block">
          <ul className="flex space-x-6 text-base text-black font-normal">
            {["Home", "Shop", "Collections", "Blogs", "Features", "More"].map(
              (item, i) => (
                <li
                  key={i}
                  className="relative cursor-pointer hover:text-[#F43297] hover:font-medium
                             after:content-['...'] after:absolute after:left-1/2 
                             after:-translate-x-1/2 after:bottom-[-10px] 
                             after:text-[#F43297] after:opacity-0 
        ...
        <div className="flex items-center space-x-4 relative">
          ...
          <FaShoppingCart className="cursor-pointer text-gray-600 hover:text-pink-600 hidden sm:block" />
          <FaHeart className="cursor-pointer text-gray-600 hover:text-pink-600 hidden sm:block" />
