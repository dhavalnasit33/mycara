...
const ImageCard = ({ name, img, textColor = "text-black" }) => {
  ...
  const lineTopMobile = 20; // mobile offset
  ...
  return (
    <div className="relative overflow-hidden cursor-pointer group h-full w-full">
      ...
      <div
        ...
        style={{
          top: `${lineTopPx}px`,
          backgroundColor: textColor === "text-black" ? "#000000" : "#ffffff",
        }}
      ></div>
...
const NewArrivals = () => {
  ...
  const earrings = { ...newArrivalItems[0], classes: "w-[428px] h-[578px] max-sm:w-[340px] max-sm:h-[240px]" };
  const shoes = { ...newArrivalItems[1], classes: "w-[568px] h-[285px] max-sm:w-[340px] max-sm:h-[169px]" };
  const watch = { ...newArrivalItems[2], classes: "w-[568px] h-[285px] max-sm:w-[340px] max-sm:h-[169px]" };
  const winterClothes = { ...newArrivalItems[3], classes: "w-[428px] h-[578px] max-sm:w-[340px] max-sm:h-[240px]" };
  ...
  return (
    <section className="py-12">
      ...
      <div className="flex justify-center mx-auto">
        <Row>
          <div className="grid gap-2 justify-center sm:grid-cols-1 md:flex md:flex-wrap md:justify-center">
