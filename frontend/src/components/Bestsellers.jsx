  ...
  return (
    <div className="relative overflow-hidden bg-white rounded-[5px] group ">
      ...
      <img
        src={product.image}
        alt={product.name}
        className="w-full sm:h-[222px]  md:h-[222px] cursor-pointer lg:h-[397.33px]  transition-transform duration-300 transform"
      />

      {/* Hover overlay */}
    <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
  <div className="w-[95%] h-[95%] bg-black bg-opacity-30 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-[5px] pointer-events-auto overflow-hidden">
