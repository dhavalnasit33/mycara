...
//         className="absolute -top-3 -left-3 w-[40px] h-[40px] pointer-events-none"
//       />
//       <div className="text-pink-600 text-3xl p-[10px] bg-color-100 w-[50px] h-[50px] rounded-[10px] flex items-center shrink-0">
